...
def scrupdate(url, sheetName, excel_file, stathead_file_path, home_team, away_team):
    ...
    team_prefixes = ['2P', '3P', 'FT', 'ORB', 'DRB', 'TOV']
    opponent_prefixes = ['2P.1', '3P.1', 'FT.1', 'ORB.1', 'DRB.1', 'TOV.1']
    ...
    rename_map = {
        ...
        "ORB%.1": "oporpercent", "DRB%.1": "opdrpercent", "TOV.1": "optov",
    }
...
excel_file = './Masterwok.xlsx'
stathead_file_paths = [
    r'C:\Users\Massimo Camuso\Desktop\NBA-NCAAB Model\teamdata\lakersdata.xlsx',  # Home team path
    r"C:\Users\Massimo Camuso\Desktop\NBA-NCAAB Model\teamdata\okcdata.xls.xlsx"]
